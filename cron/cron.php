<?php
    ...
    if($CMSNT->site('stt_giaodichao') == 'ON')
    {
        ...
        if($int_rand == 20)
        {
            ...
            $array_username = ['0989798568', '0798987985', '01254989498', 'phanxichlo', 'toitenla', 'nguyentrinh', 'buihien', 'phong9899', 'phat1412', 'conlaollll', 'hotnek2', 'hocgioigioihoc', 'toite132', '0989897986', '984659864', '97986599', '065498989', '019898985', 'giaosuhaykhoc', 'thanhpro', 'shopaka', 'huyenngoc', 'lamka231'];
